...
const STRUCTURE_FIELDS = ['situation', 'challenge', 'role', 'actions', 'outcome']

export function getCompletenessScore(experience) {
...
export function getCompletenessFlags(experience) {
...
export function getCompletenessColor(experience) {
